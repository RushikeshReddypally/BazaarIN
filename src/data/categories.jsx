...
const bounceY = { normal: { y: 0 }, animate: { y: [0, -3, 0] } }
const scalePulse = { normal: { scale: 1 }, animate: { scale: [1, 1.15, 1] } }
const wiggle = { normal: { rotate: 0 }, animate: { rotate: [0, -8, 8, 0] } }
const shakeX = { normal: { x: 0 }, animate: { x: [0, -2, 2, -2, 0] } }
const spin = { normal: { rotate: 0 }, animate: { rotate: 360 } }

export const categoryIcons = {
  all: (props) => (
    <AnimatedIcon variants={scalePulse} transition={{ duration: 0.35 }} {...props}>
      <rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/>
      <rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>
    </AnimatedIcon>
  ),
  vehicles: (props) => (
    <AnimatedIcon variants={shakeX} transition={{ duration: 0.4 }} {...props}>
      <path d="M5 17H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h14l4 4v4a2 2 0 0 1-2 2h-2" />
      <circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>
    </AnimatedIcon>
  ),
  bikes: (props) => (
    <AnimatedIcon variants={bounceY} transition={{ duration: 0.4 }} {...props}>
      <circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/>
      <path d="M15 6h-3l-3 8m0 0H5.5m6.5 0 2-5.5" /><path d="M12 6l2 5.5"/>
    </AnimatedIcon>
  ),
  mobiles: (props) => (
    <AnimatedIcon variants={wiggle} transition={{ duration: 0.4 }} {...props}>
  ...
  sports: (props) => (
    <AnimatedIcon variants={spin} transition={{ duration: 0.6, ease: 'easeInOut' }} {...props}>
  ...
  gaming: (props) => (
    <AnimatedIcon variants={shakeX} transition={{ duration: 0.35 }} {...props}>
